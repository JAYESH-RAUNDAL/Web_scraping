...
import json
r=s.post(login_url,data=json.dumps(payload)) #WE ARE LOGIN INTO SCAPING WEBSITE
headers={}
...
responce=s.post(scrap_url,headers=headers,data=json.dumps(dict)) #WE ARE IN SCRPING LINK
#print(responce.json())
